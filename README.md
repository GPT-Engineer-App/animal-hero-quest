...
**Project**: animal-hero-quest 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Id like to do a web app thats a game for a kid that will select the correct animal amongst four choices. Show images of four animals at a time and ask the user to select one

example: Select the cow.
...
```sh
git clone https://github.com/GPT-Engineer-App/animal-hero-quest.git
cd animal-hero-quest
npm i
